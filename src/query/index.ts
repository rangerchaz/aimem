...
import type { Structure, Conversation, Extraction } from '../types/index.js';
 ...
 */
export function getEntityContext(entityName: string): ContextResult {
 ...
 */
export function searchContext(query: string, limit = 10): ContextResult {
  const result: ContextResult = {
    structures: [],
    decisions: [],
    rejections: [],
 ...
 */
export function formatContextForInjection(context: ContextResult): string {
  const parts: string[] = [];
