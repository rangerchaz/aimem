...
import { extractDecisions, generateSummary, type TranscriptMessage } from '../src/extractor/index.js';
...
describe('Decision Extractor', () => {
  describe('extractDecisions', () => {
    ...
    it('should deduplicate similar extractions', () => {
      ...
      const redisDecisions = extractions.filter(e =>
        e.content.toLowerCase().includes('redis') && e.type === 'decision'
      );
